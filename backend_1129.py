...
# Note: consider m."id" = ii."id"
    ...
    recommendations_data = [
        {'Dephours': dep_hour, 'Arrhours': arr_hour, 'Elptime': elaptime,
         'Connection_time': connection_time, 'Market_share': market_share, 'Option': option}
        for dep_hour, arr_hour, elaptime, connection_time, market_share, option in recommendations
    ]
...
# Expect: return one tot_pax, one accuracy
...
# Expect: return one value per component
